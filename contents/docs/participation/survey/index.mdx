...
• Optional: Sign up to receive study results

**Later:**
• Your responses become part of aggregate findings (November 2025)
• No individual responses ever shared
• Research outcomes available to all participants
...
**Questions before you start?** Visit our [Contact](/contact) page.
- **Well-being connections** between quiet time and mental health
...
### What Happens Next
- Your anonymous responses are added to our research dataset
- No follow-up contact unless you specifically request it
- Your data contributes to academic analysis and theme identification
- Research findings will be shared publicly while maintaining anonymity

### Receiving Research Results
If you'd like to receive a summary of research findings (completely optional):
- Provide an email address in the final survey question
- Receive a research summary in December 2025
- Your email will only be used for this purpose and then deleted
...
- Review our [privacy policies](/privacy) for detailed data protection information
- Learn more about [study methodology](/methodology) and research approach
